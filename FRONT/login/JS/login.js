document.addEventListener('DOMContentLoaded', () => {
    // ===============================================
    // LÓGICA DOS FORMULÁRIOS (Existente)
    // ===============================================
    ...
    registerForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            registerMessage.textContent = 'Erro ao registar. O e-mail já pode existir.';
    ...
    // ===============================================
    // NOVA LÓGICA DO CANVAS DE FUNDO
    // ===============================================
    const canvas = document.getElementById('background-canvas');
    const ctx = canvas.getContext('2d');

    let particles = [];
    const particleCount = 70; // Menos partículas para um efeito minimalista
    ...
    class Particle {
        ...
        draw() {
            ctx.fillStyle = 'rgba(255, 122, 0, 0.5)'; // Cor primária com transparência
            ctx.beginPath();
