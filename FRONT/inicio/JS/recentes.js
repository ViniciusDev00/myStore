      ...
      .map(
        (product) => `
            <div class="swiper-slide">
                <a href="../../produto/HTML/produto.html?id=${
                  product.id
                }" class="product-card-link">
                    <div class="product-card" data-id="${product.id}">
                        <div class="product-image-wrapper">
                            <img src="${
                              product.imagemUrl || "path/to/placeholder.png"
                            }" alt="${product.nome}">
                        </div>
                        <div class="product-info">
                            ...
                            <p class="product-price">R$ ${product.preco
                              .toFixed(2)
                              .replace(".", ",")}</p>
    ...
    try {
      ...
      sectionsToBuild.forEach((section) => {
        const filteredProducts = allProducts.filter(
          (p) => p.categoria.nome === section.categoryName
        );
