-- Apagar dados existentes para garantir um estado limpo
...
-- Inserir Produtos com o novo campo preco_original
...
-- A LINHA DE INSERÇÃO DO USUÁRIO ADMIN FOI REMOVIDA DAQUI